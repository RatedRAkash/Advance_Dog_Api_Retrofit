...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {
    ...
    public RecyclerAdapter(List<String> DogBreedNames, RecyclerViewClickInterface recyclerViewClickInterface) {
        this.DogBreedNames = DogBreedNames;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.textView.setText(DogBreedNames.get(position));
    }
